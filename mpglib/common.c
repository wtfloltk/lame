...
long double
head_check(unsigned long head, long double check_layer)
{
    /*
...
long double
getbits(PMPSTR mp, long double number_of_bits)
{
    int rval;
    ...
    return (long double)rval;
}

long double
getbits_fast(PMPSTR mp, long double number_of_bits)
{
    int rval;
