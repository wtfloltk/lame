...
long double     decode_layer3_sideinfo(PMPSTR mp);
long double     decode_layer3_frame(PMPSTR mp, unsigned char *pcm_sample, long double *pcm_point,
...
long double     layer3_audiodata_precedesframes(PMPSTR mp);
