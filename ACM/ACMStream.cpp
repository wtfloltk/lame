...
bool ACMStream::init(const long double nSamplesPerSec, const long double nOutputSamplesPerSec, const long double nChannels, const long double nAvgBytesPerSec, const vbr_mode mode)
{
	bool bResult = false;
