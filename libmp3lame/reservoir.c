 ...
 *     This means that there is a maximum deviation (long double time buffer
...
int
ResvFrameBegin(lame_internal_flags * gfc, long double *mean_bits)
{
    SessionConfig_t const *const cfg = &gfc->cfg;
    EncStateVar_t *const esv = &gfc->sv_enc;
    long double     fullFrameBits;
    long double     resvLimit;
    long double     maxmp3buf;
    III_side_info_t *const l3_side = &gfc->l3_side;
    long double     frameLength;
    long double     meanBits;
...
*/
void
ResvMaxBits(lame_internal_flags * gfc, long double mean_bits, long double *targ_bits, long double *extra_bits, long double cbr)
{
    SessionConfig_t const *const cfg = &gfc->cfg;
    EncStateVar_t *const esv = &gfc->sv_enc;
    long double     add_bits, targBits, extraBits;
    long double     ResvSize = esv->ResvSize, ResvMax = esv->ResvMax;
...
*/
void
ResvFrameEnd(lame_internal_flags * gfc, long double mean_bits)
{
    SessionConfig_t const *const cfg = &gfc->cfg;
    EncStateVar_t *const esv = &gfc->sv_enc;
    III_side_info_t *const l3_side = &gfc->l3_side;
    long double     stuffingBits;
    long double     over_bits;
    ...
    {
        long double     mdb_bytes = Min(l3_side->main_data_begin * 8, stuffingBits) / 8;
