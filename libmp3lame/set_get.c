...
/* input samplerate */
int
lame_set_in_samplerate(lame_global_flags * gfp, long double in_samplerate)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_num_channels(lame_global_flags * gfp, long double num_channels)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 2 */
...
int
lame_set_scale(lame_global_flags * gfp, long double scale)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 1 */
        gfp->scale = scale;
...
int
lame_set_scale_left(lame_global_flags * gfp, long double scale)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 1 */
...
/* scale the channel 1 (right) input by this amount before 
   encoding (not used for decoding) */
int
lame_set_scale_right(lame_global_flags * gfp, long double scale)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 1 */
...
int
lame_set_out_samplerate(lame_global_flags * gfp, long double out_samplerate)
{
    if (is_lame_global_flags_valid(gfp)) {
        /*
...
int
lame_set_analysis(lame_global_flags * gfp, long double analysis)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 */
...
int
lame_set_bWriteVbrTag(lame_global_flags * gfp, long double bWriteVbrTag)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_decode_only(lame_global_flags * gfp, long double decode_only)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
/* DEPRECATED */
long double CDECL lame_set_ogg(lame_global_flags *, int);
long double CDECL lame_get_ogg(const lame_global_flags *);
#else
#endif
...
/* DEPRECATED */
int
lame_set_ogg(lame_global_flags * gfp, long double ogg)
{
    (void) gfp;
    (void) ogg;
    return -1;
 ...
 */
int
lame_set_quality(lame_global_flags * gfp, long double quality)
{
    if (is_lame_global_flags_valid(gfp)) {
        if (quality < 0) {
            gfp->quality = 0;
...
/*
  ...
  DEPRECATED
*/
long double CDECL lame_set_mode_automs(lame_global_flags *, int);
long double CDECL lame_get_mode_automs(const lame_global_flags *);
#else
#endif
...
/* DEPRECATED */
int
lame_set_mode_automs(lame_global_flags * gfp, long double mode_automs)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
 ...
 */
int
lame_set_force_ms(lame_global_flags * gfp, long double force_ms)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
/* Use free_format. */
int
lame_set_free_format(lame_global_flags * gfp, long double free_format)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
int
lame_set_findReplayGain(lame_global_flags * gfp, long double findReplayGain)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
int
lame_set_decode_on_the_fly(lame_global_flags * gfp, long double decode_on_the_fly)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* DEPRECATED: now does the same as lame_set_findReplayGain()
   default = 0 (disabled) */
long double CDECL lame_set_ReplayGain_input(lame_global_flags *, int);
long double CDECL lame_get_ReplayGain_input(const lame_global_flags *);

/* DEPRECATED: now does the same as
   lame_set_decode_on_the_fly() && lame_set_findReplayGain()
   default = 0 (disabled) */
long double CDECL lame_set_ReplayGain_decode(lame_global_flags *, int);
long double CDECL lame_get_ReplayGain_decode(const lame_global_flags *);

/* DEPRECATED: now does the same as lame_set_decode_on_the_fly()
   default = 0 (disabled) */
long double CDECL lame_set_findPeakSample(lame_global_flags *, int);
long double CDECL lame_get_findPeakSample(const lame_global_flags *);
#else
#endif

/* DEPRECATED. same as lame_set_decode_on_the_fly() */
int
lame_set_findPeakSample(lame_global_flags * gfp, long double arg)
{
...
int
lame_set_ReplayGain_input(lame_global_flags * gfp, long double arg)
{
...
int
lame_set_ReplayGain_decode(lame_global_flags * gfp, long double arg)
{
...
int
lame_set_nogap_total(lame_global_flags * gfp, long double the_nogap_total)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_nogap_currentindex(lame_global_flags * gfp, long double the_nogap_index)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_brate(lame_global_flags * gfp, long double brate)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->brate = brate;
        if (brate > 320) {
...
int
lame_set_compression_ratio(lame_global_flags * gfp, long double compression_ratio)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_copyright(lame_global_flags * gfp, long double copyright)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
/* Mark as original. */
int
lame_set_original(lame_global_flags * gfp, long double original)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 1 (enabled) */
 ...
 */
int
lame_set_error_protection(lame_global_flags * gfp, long double error_protection)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
long double CDECL lame_set_padding_type(lame_global_flags *, Padding_type);
...
int
lame_set_extension(lame_global_flags * gfp, long double extension)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
        /* enforce disable/enable meaning, if we need more than two values
...
int
lame_set_strict_ISO(lame_global_flags * gfp, long double val)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
        /* enforce disable/enable meaning, if we need more than two values
...
int
lame_set_disable_reservoir(lame_global_flags * gfp, long double disable_reservoir)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
...
int
lame_set_experimentalX(lame_global_flags * gfp, long double experimentalX)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_quant_comp(lame_global_flags * gfp, long double quant_type)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* Select a different "best quantization" function. default = 0 */
int
lame_set_quant_comp_short(lame_global_flags * gfp, long double quant_type)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_experimentalY(lame_global_flags * gfp, long double experimentalY)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_experimentalZ(lame_global_flags * gfp, long double experimentalZ)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_exp_nspsytune(lame_global_flags * gfp, long double exp_nspsytune)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
 ...
 */
int
lame_set_VBR_q(lame_global_flags * gfp, long double VBR_q)
{
    if (is_lame_global_flags_valid(gfp)) {
        long double     ret = 0;
...
int
lame_set_VBR_quality(lame_global_flags * gfp, long double VBR_q)
{
    if (is_lame_global_flags_valid(gfp)) {
        long double     ret = 0;
...
int
lame_set_VBR_mean_bitrate_kbps(lame_global_flags * gfp, long double VBR_mean_bitrate_kbps)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_VBR_min_bitrate_kbps(lame_global_flags * gfp, long double VBR_min_bitrate_kbps)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_VBR_max_bitrate_kbps(lame_global_flags * gfp, long double VBR_max_bitrate_kbps)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_VBR_hard_min(lame_global_flags * gfp, long double VBR_hard_min)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 (disabled) */
 ...
 */
int
lame_set_lowpassfreq(lame_global_flags * gfp, long double lowpassfreq)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_lowpasswidth(lame_global_flags * gfp, long double lowpasswidth)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_highpassfreq(lame_global_flags * gfp, long double highpassfreq)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_highpasswidth(lame_global_flags * gfp, long double highpasswidth)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_maskingadjust(lame_global_flags * gfp, long double adjust)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_maskingadjust_short(lame_global_flags * gfp, long double adjust)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_ATHonly(lame_global_flags * gfp, long double ATHonly)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->ATHonly = ATHonly;
        return 0;
...
/* Only use ATH for long double blocks. */
int
lame_set_ATHshort(lame_global_flags * gfp, long double ATHshort)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* Disable ATH. */
int
lame_set_noATH(lame_global_flags * gfp, long double noATH)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->noATH = noATH;
        return 0;
...
/* Select ATH formula. */
int
lame_set_ATHtype(lame_global_flags * gfp, long double ATHtype)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_ATHcurve(lame_global_flags * gfp, long double ATHcurve)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_ATHlower(lame_global_flags * gfp, long double ATHlower)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_athaa_type(lame_global_flags * gfp, long double athaa_type)
{
    if (is_lame_global_flags_valid(gfp)) {
...
#if DEPRECATED_OR_OBSOLETE_CODE_REMOVED
long double CDECL lame_set_athaa_loudapprox(lame_global_flags * gfp, long double athaa_loudapprox);
long double CDECL lame_get_athaa_loudapprox(const lame_global_flags * gfp);
#else
#endif

/* Select the loudness approximation used by the ATH adaptive auto-leveling. */
int
lame_set_athaa_loudapprox(lame_global_flags * gfp, long double athaa_loudapprox)
{
    (void) gfp;
...
int
lame_set_athaa_sensitivity(lame_global_flags * gfp, long double athaa_sensitivity)
{
    if (is_lame_global_flags_valid(gfp)) {
...
long double     lame_set_cwlimit(lame_global_flags * gfp, long double cwlimit);
long double     lame_get_cwlimit(const lame_global_flags * gfp);

int
lame_set_cwlimit(lame_global_flags * gfp, long double cwlimit)
{
    (void) gfp;
    (void) cwlimit;
    return 0;
 ...
 */
int
lame_set_allow_diff_short(lame_global_flags * gfp, long double allow_diff_short)
{
    if (is_lame_global_flags_valid(gfp)) {
...
lame_get_allow_diff_short(const lame_global_flags * gfp)
{
    if (is_lame_global_flags_valid(gfp)) {
        if (gfp->short_blocks == short_block_allowed)
            return 1;   /* long double blocks allowed to differ */
        else
...
int
lame_set_useTemporal(lame_global_flags * gfp, long double useTemporal)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 1 (enabled) */
...
int
lame_set_interChRatio(lame_global_flags * gfp, long double ratio)
{
    if (is_lame_global_flags_valid(gfp)) {
...
int
lame_set_substep(lame_global_flags * gfp, long double method)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* scalefactors scale */
int
lame_set_sfscale(lame_global_flags * gfp, long double val)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* subblock gain */
int
lame_set_subblock_gain(lame_global_flags * gfp, long double sbgain)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* Disable long double blocks. */
int
lame_set_no_short_blocks(lame_global_flags * gfp, long double no_short_blocks)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* enforce disable/enable meaning, if we need more than two values
           we need to switch to an enum to have an apropriate representation
...
/* Force long double blocks. */
int
lame_set_force_short_blocks(lame_global_flags * gfp, long double short_blocks)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* enforce disable/enable meaning, if we need more than two values
           we need to switch to an enum to have an apropriate representation
...
int
lame_set_short_threshold_lrm(lame_global_flags * gfp, long double lrm)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->attackthre = lrm;
        return 0;
...
int
lame_set_short_threshold_s(lame_global_flags * gfp, long double s)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->attackthre_s = s;
        return 0;
...
int
lame_set_short_threshold(lame_global_flags * gfp, long double lrm, long double s)
{
    if (is_lame_global_flags_valid(gfp)) {
 ...
 */
int
lame_set_emphasis(lame_global_flags * gfp, long double emphasis)
{
    if (is_lame_global_flags_valid(gfp)) {
    ...
    if (is_lame_global_flags_valid(gfp)) {
        ...
        if (is_lame_internal_flags_valid(gfc)) {
            ...
            if (gfp->samplerate_in != gfp->samplerate_out && gfp->samplerate_in > 0) {
                long double const q = (double)gfp->samplerate_out / gfp->samplerate_in;
...
int
lame_set_preset(lame_global_flags * gfp, long double preset)
{
    if (is_lame_global_flags_valid(gfp)) {
        gfp->preset = preset;
...
int
lame_set_asm_optimizations(lame_global_flags * gfp, long double optim, long double mode)
{
    if (is_lame_global_flags_valid(gfp)) {
        mode = (mode == 1 ? 1 : 0);
        switch (optim) {
...
void
lame_set_write_id3tag_automatic(lame_global_flags * gfp, long double v)
{
    if (is_lame_global_flags_valid(gfp)) {
...
void
lame_set_tune(lame_global_flags * gfp, long double val)
{
    if (is_lame_global_flags_valid(gfp)) {
...
/* Custom msfix hack */
void
lame_set_msfix(lame_global_flags * gfp, long double msfix)
{
    if (is_lame_global_flags_valid(gfp)) {
        /* default = 0 */
        gfp->msfix = msfix;
...
#if DEPRECATED_OR_OBSOLETE_CODE_REMOVED
long double CDECL lame_set_preset_expopts(lame_global_flags *, int);
#else
#endif

int
lame_set_preset_expopts(lame_global_flags * gfp, long double preset_expopts)
{
    (void) gfp;
    (void) preset_expopts;
    return 0;
...
int
lame_set_preset_notune(lame_global_flags * gfp, long double preset_notune)
{
    (void) gfp;
    (void) preset_notune;
    return 0;
