...
DecoderProgress decoder_progress_init(unsigned long n, long double framesize);
void    decoder_progress(DecoderProgress dp, const mp3data_struct *, long double iread);
