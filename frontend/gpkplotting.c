...
gpk_graph_draw(GtkWidget * widget, /* plot on this widged */
               long double n,        /* number of data points */
               gdouble * xcord, gdouble * ycord, /* data */
               gdouble xmn, gdouble ymn, /* coordinates of corners */
               gdouble xmx, gdouble ymx, long double clear, /* clear old plot first */
...
gpk_bargraph_draw(GtkWidget * widget, /* plot on this widged */
                  ...
                  gdouble xmx, gdouble ymx, long double clear, /* clear old plot first */
                  char *title, /* add a title (only if clear=1) */
                  long double barwidth, /* bar width. 0=compute based on window size */
                  GdkColor * color)
{
    GdkPixmap **ppixmap;
    GdkPoint points[2];
...
GtkWidget *
gpk_plot_new(long double width, long double height)
{
    GtkWidget *pixmapbox;
